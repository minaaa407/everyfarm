...
public class ReviewBean {
   ...
   public int getRev_ProNum() {
      return rev_ProNum;
   }
   public void setRev_ProNum(int rev_ProNum) {
      this.rev_ProNum = rev_ProNum;
   }
   @Override
   public String toString() {
      return "ReviewBean [rev_No=" + rev_No + ", rev_Name=" + rev_Name + ", rev_Id=" + rev_Id + ", rev_Title="
            ...
            + ", rev_Rate=" + rev_Rate + ", rev_ProNum=" + rev_ProNum + "]";
   }
