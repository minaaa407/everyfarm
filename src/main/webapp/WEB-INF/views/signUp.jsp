...
<body>
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="last_name" class="required">비밀번호</label>
                                    <input type="text" name="last_name" id="last_name" />
                                </div>
                                <div class="form-input">
                                    <label for="company" class="required">비밀번호 확인</label>
                        ...
                        <div class="form-submit">
                            <input type="submit" value="가입하기" class="submit" id="submit" name="submit" />
                            <input type="button" value="취소" class="submit" id="reset" name="reset" />
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script src="resources/sign/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
    <script src="resources/sign/vendor/jquery-validation/dist/additional-methods.min.js"></script>
