			...
			<div class="container-fluid mt--7">
				...
				<div class="container">
					<div class="row">
						...
						<div align="right" class="col-lg-12 col-md-12">
						...
						<c:choose>
								<c:when test="${oneproduct.p_Accept eq 'N'}">
							...
							<div class="product__details__text">
								...
								<div>
									...
									<div class="select"
										...
										<ul>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/감자.png" />감자</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/고구마.png" />고구마</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/콩.png" />콩</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/배추.png" />배추</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/상추.png" />상추</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/수박.png" />수박</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/오이.png" />오이</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/토마토.png" />토마토</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/호박.png" />호박</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/고추.png" />고추</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/마늘.png" />마늘</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/파.png" />파</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/양파.png" />양파</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/무.png" />무</li>
											<li onClick="listChange()"><img height="50px"
												width="50px" src="/resources/product/img/당근.png" />당근</li>
										</ul>
								...
								<form>
									...
									<i class="fas fa-minus-circle"
										...
										value=1 size=10><i class="fas fa-plus-circle"
										style='font-size: 24px; vertical-align: middle;'></i> <input
												...
												<tr>
													<c:choose>
														<c:when test="${q.c_Subno > 0}">
															<td style="width: 80%; padding-left: 20px;"><span
																style="font-size: 20px">└</span> ${q.c_Content } <br>
															</td>
														</c:when>
														<c:otherwise>
															<td style="width: 80%">${q.c_Content }<br>
															</td>
														</c:otherwise>
													</c:choose>
													<td style="width: 20%">${q.c_Id }<br> ${q.c_Date }<br>
													</td>
												</tr>
												<tr>
													<td><c:if
															test="${(q.c_Subno == 0 && (not empty farmer || not empty admin))&&q.c_Id !='삭제'}">
															<input name="${q.c_Seq}" class="qnasubbutton"
																type="button" value="답글"
																onclick="qnasubbutton('${q.c_Seq}')" />
														</c:if></td>
													<td><c:if
															test="${(not empty farmer || not empty admin ||(not empty member && member.m_Id == q.c_Id))&&q.c_Id !='삭제'}">
															<input name="${q.c_Seq}" class="updatebutton"
																type="button" value="수정"
																onclick="updatebutton('${q.c_Seq}')" />&nbsp;
