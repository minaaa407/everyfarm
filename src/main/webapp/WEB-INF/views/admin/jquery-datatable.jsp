...
<!-- Favicon-->
<link rel="icon" href="resources/admin/list/favicon.ico" type="image/x-icon">
...
<!-- Bootstrap Core Css -->
<link href="resources/admin/list/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">

<!-- Waves Effect Css -->
<link href="resources/admin/list/plugins/node-waves/waves.css" rel="stylesheet" />

<!-- Animation Css -->
<link href="resources/admin/list/plugins/animate-css/animate.css" rel="stylesheet" />

<!-- JQuery DataTable Css -->
<link
	href="resources/admin/list/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css"
	rel="stylesheet">

<!-- Custom Css -->
<link href="resources/admin/list/css/style.css" rel="stylesheet">

<!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
<link href="resources/admin/list/css/themes/all-themes.css" rel="stylesheet" />
</head>
...
<body class="theme-red">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					class="bars"></a> <a class="navbar-brand" href="/admin">ADMINBSB
					- MATERIAL DESIGN</a>
			</div>
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				<div class="image">
					<img src="resources/admin/list/images/user.png" width="48" height="48" alt="User" />
				</div>
