...
<body>
			...
			<div class="wrap-login">
				<form class="login-form" action="login" method="post">
					...
					<div class="login-form-btn-container">
						...
						<!-- kakao -->
						<a
							href="https://kauth.kakao.com/oauth/authorize?client_id=498888e1cfaa9f3669cf117f84502ba4&redirect_uri=http://localhost:8090/kakao_login&response_type=code"><img
	...
	function search_check(num){
		if(num == '1'){
			...
			document.getElementById("farmerPW").style.display = "";
		}else{
			document.getElementById("memberID").style.display = "none";
			document.getElementById("memberPW").style.display = "";
		}
	}
	</script>
