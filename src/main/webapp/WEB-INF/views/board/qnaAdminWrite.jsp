...
<%--         <div class="errorMsg">
      ...
      <%--   <c:choose>
		...
		<form action="/qnaAdupdate" id="qna" name="qna" method="post" enctype="multipart/form-data">
		<c:forEach items="${modifyAdrecord}" var="q"> 	

		 <table class="table table-striped">
             
             <input type="hidden" name="qa_No" value="${q.qa_No}" />
             
             <tr>
                <td>비밀글</td>
                <label><td><input type="checkbox" name="qa_Secret" value="1" 
                				<c:if test="${q.qa_Secret eq 'true'}">checked</c:if> ></td></label>
      		 </tr>
      		 
      		
            <tr>
                <td>제목</td>
                <td><input type="text" id="title" name="qa_Title" class="form-control" value="${q.qa_Title}" ></td>
            </tr>
            
            <tr>
                <td>작성자</td>
                <td><input type="text" id="q_Id" name="qa_Id" value="<%=member.getM_Id()%>"  class="form-control" readonly></td>
            </tr>
...
<fieldset class="rating">
    ...
    <input type="radio" id="starhalf" name="rev_Rate" value="0.5" /><label class="half" for="starhalf" ></label>
            ...
            <!-- <tr>
                <td></td>
                <td><input multiple="multiple" type="file" name="qa_Img" accept="image/gif, image/jpg, image/jpeg, image/png"/></td>
            </tr> -->
             
            <tr>
                <td>글내용</td>
                <td>
   				 <textarea id="summernote"  name="qa_Content" rows="30" style="width:100%;">${q.qa_Content}</textarea>
              </td>
            </tr>
             <tr>
             	<td colspan="2"  class="text-center">
                   ...
                   <!--  <input type="reset" value="다시작성" class="btn btn-warning"> -->
                    <button type="button"  class="btn btn-primary" onclick="location.href='/qnalist/admin'">목록으로 돌아가기</button>
                </td>
            </tr>
	 ...
	 <form action="/qnaAdinsert" id="qna" name="qna" method="post" enctype="multipart/form-data">


          <table class="table table-striped">
             <tr>
                <td>비밀글</td>
                <label><td><input type="checkbox" name="qa_Secret" value="1">비밀글</td></label>
      		 </tr>
     
            <tr>
                <td>제목</td>
                <td><input type="text" id="title" name="qa_Title" class="form-control"></td>
            </tr>
    ...
    <input type="radio" id="starhalf" name="rev_Rate" value="0.5" /><label class="half" for="starhalf" ></label>
        ...
        <!--     <tr>
            ...
            <tr>
                <td>글내용</td>
                <td>
   				 <textarea id="summernote"  name="qa_Content" rows="30" style="width:100%;"></textarea>
                </td>
            </tr>
            <tr>
