...
<link
	...
	rel="stylesheet">
<!-- Icons -->
<link href="resources/farmer/js/plugins/nucleo/css/nucleo.css"
	rel="stylesheet" />
<link
	href="resources/farmer/js/plugins/@fortawesome/fontawesome-free/css/all.min.css"
	rel="stylesheet" />
<!-- CSS Files -->
...
<body>
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link "
			href="/proLandListForm "> <i class="ni ni-box-2 text-blue"></i>
				상품관리
		</a></li>
		<li class="nav-item"><a class="nav-link "
		...
		<li class="nav-item"><a class="nav-link " href="/farmerQnaList">
				<i class="ni ni-bullet-list-67 text-blue"></i> Q&A관리
		</a></li>
