				...
				<div class="col-md-8 order-md-last">
					<div class="row">
						<div class="col-md-6 text-center">
							<a class="navbar-brand" href="/farmer">FARMER <span>FARM</span></a>
						</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="ftco-nav">
					<ul class="navbar-nav m-auto">
						<li class="nav-item active"><a href="/farmer"
							class="nav-link">Home</a></li>
						<li class="nav-item"><a href="#" class="nav-link">회원 관리</a></li>
						<li class="nav-item"><a href="#" class="nav-link">경작지 관리</a></li>
						<li class="nav-item"><a href="#" class="nav-link">결제 관리</a></li>
						<li class="nav-item"><a href="#" class="nav-link">관리</a></li>
						<li class="nav-item"><a href="#" class="nav-link">관리</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row mb-5">
				<div class="col-md-6 col-lg">
					<div class="ftco-footer-widget mb-4">
						<h2 class="logo">
							<a href="/farmer">EVERY <span>FARM</span></a>
						</h2>
