...
<title>EVERY FARM 농부 | 리뷰관리</title>
														...
														<div class="text">
															<table class="table">
																...
																<tbody>
																	...
																	<c:if test="${!empty repList}">
																		<c:forEach var="re" items="${repList}">
																			<tr>
																				<td><a href="/reviewDetail?rev_No=${re.rev_No}">${re.rep_Cont}</a></td>
																				<td style="text-align: center;"><fmt:formatDate
																						pattern="yyyy/MM/dd" value="${re.rep_Date}"/></td>
																			</tr>
																		</c:forEach>
																	</c:if>
																</tbody>
